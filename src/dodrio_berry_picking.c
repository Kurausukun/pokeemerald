...
static const u8 sPrizeBerryIds[][10] =
{
    { // Possible prizes with 3 players
        ITEM_TO_BERRY_1(ITEM_RAZZ_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_BLUK_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_NANAB_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_WEPEAR_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_PINAP_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_PINAP_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_WEPEAR_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_NANAB_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_BLUK_BERRY) - 1,
    ...
    { // Possible prizes with 4 players
        ITEM_TO_BERRY_1(ITEM_POMEG_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_KELPSY_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_QUALOT_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_HONDEW_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_GREPA_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_TAMATO_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_CORNN_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_MAGOST_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_RABUTA_BERRY) - 1,
        ITEM_TO_BERRY_1(ITEM_NOMEL_BERRY) - 1
    },
...
{
    return sGame->berryResults[sGame->multiplayerId][BERRY_PRIZE] + FIRST_BERRY_INDEX_1;
}
