...
const u32 sLevelCapReduction[7] = { 50, 33, 25, 20, 15, 10, 05 };
const u32 sRelativePartyScaling[27] =
{
    300, 275, 250, 233, 225,
    200, 180, 170, 160, 150,
    140, 130, 120, 110, 100,
...
u32 GetPkmnExpMultiplier(u32 level)
{
    u32 i;
    u32 lvlCapMultiplier = 1;
    u32 levelDiff;
    s32 avgDiff;
    ...
    case 2: // set exp value to the poke in expgetter_id and print message
        if (gBattleControllerExecFlags == 0)
        {
            ...
            else
            {
                ...
                {
                    u32 expMultiplier = GetPkmnExpMultiplier(gPlayerParty[gBattleStruct->expGetterMonId].level);
                    ...
                    gBattleMoveDamage = Q_24_8_TO_INT((gBattleMoveDamage + 128) / 100); // all multipliers are *100 to reduce error
