...
extern const u32 gItemIcon_Pumkin[];
extern const u32 gItemIconPalette_Pumkin[];
extern const u32 gItemIcon_Drash[];
extern const u32 gItemIconPalette_Drash[];
extern const u32 gItemIcon_Eggant[];
extern const u32 gItemIconPalette_Eggant[];
extern const u32 gItemIcon_Strib[];
extern const u32 gItemIconPalette_Strib[];
extern const u32 gItemIcon_Chilan[];
extern const u32 gItemIconPalette_Chilan[];
extern const u32 gItemIcon_Nutpea[];
extern const u32 gItemIconPalette_Nutpea[];
extern const u32 gItemIcon_Nion[];
extern const u32 gItemIconPalette_Nion[];
extern const u32 gItemIcon_Rako[];
extern const u32 gItemIconPalette_Rako[];
extern const u32 gItemIcon_Bitmel[];
extern const u32 gItemIconPalette_Bitmel[];
extern const u32 gItemIcon_Chipep[];
extern const u32 gItemIconPalette_Chipep[];
extern const u32 gItemIcon_Galic[];
extern const u32 gItemIconPalette_Galic[];
extern const u32 gItemIcon_Topo[];
extern const u32 gItemIconPalette_Topo[];
...
extern const u32 gBerryPic_Nion[];
extern const u32 gBerryPalette_Nion[];
extern const u32 gBerryPic_Rako[];
extern const u32 gBerryPalette_Rako[];
extern const u32 gBerryPic_Bitmel[];
extern const u32 gBerryPalette_Bitmel[];
extern const u32 gBerryPic_Chipep[];
extern const u32 gBerryPalette_Chipep[];
extern const u32 gBerryPic_Galic[];
extern const u32 gBerryPalette_Galic[];
