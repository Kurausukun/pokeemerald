const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_PUMKIN_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_DRASH_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_EGGANT_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_STRIB_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_CHILAN_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_NUTPEA_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_NION_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_RAKO_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_BITMEL_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_CHIPEP_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_GALIC_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
    [ITEM_TOPO_BERRY] = {gItemIcon_EnigmaBerry, gItemIconPalette_EnigmaBerry},
